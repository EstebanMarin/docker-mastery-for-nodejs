...
*** Assignment: MTA (Migrating Traditional Apps)
    We will migrate this [[./assignment-mta/README.md][App]] with these files to container found in the  =./assigment-mta= 
...
**** Checklist [66%] [2/3]:
     ...
     - [ ] Change =Winston= transport to console, opposed to logging to a file
**** MTA Requirements [0%] [0/5]:
     - [ ] See *Readme.md* for =app= details
     - [ ] Image should not include =in=, =out=, =node_modules=, or =logs= directories in =.dockerignore=
     - [ ] Open the =index.js= file to update transport of Winston to console
     ...
     - [ ] Change the *environment* variable to get different results
